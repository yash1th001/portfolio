  ...
  return (
    <section id="about" className="py-32 relative">
      <div className="container mx-auto px-6 md:px-12">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold tracking-tight">01. Background</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
          {stats.map((stat, i) => (
            <motion.div
              ...
              className="flex flex-col items-center justify-center p-4 border border-border bg-card/30 rounded-xl hover:border-primary/50 transition-colors group relative overflow-hidden"
            >
              <div className="absolute inset-0 bg-primary/5 translate-y-full group-hover:translate-y-0 transition-transform duration-300" />
              <span className="text-3xl font-mono font-bold text-foreground group-hover:text-primary transition-colors mb-1 relative z-10">{stat.value}</span>
              <span className="text-xs font-mono text-muted-foreground uppercase tracking-widest relative z-10">{stat.label}</span>
            </motion.div>
          ))}
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-start">
          <motion.div 
            ...
            className="lg:col-span-7 relative pl-8 border-l-2 border-primary/20 glow-border-left"
          >
          ...
          >
            ...
            <div className="bg-[#1a1a24] px-4 py-3 flex items-center gap-2 border-b border-border">
              ...
              <div className="mx-auto text-xs font-mono text-muted-foreground/60 tracking-wider">
                tyashwanth@node-01:~/specs
              </div>
            </div>
            
            {/* Terminal Body */}
            <div className="p-6 md:p-8 font-mono text-sm shadow-[inset_0_0_20px_hsla(150,100%,50%,0.03)] h-full">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row">
                  ...
                  <a href="mailto:yashwanth.99122@gmail.com" className="text-primary hover:underline transition-all hover:text-emerald-300">
